...
<a
	...
	class="group relative aspect-projectMin h-full w-full overflow-hidden rounded border bg-card text-card-foreground no-underline shadow-lg transition-all md:aspect-project
	{props.class ?? ''} "
	{...props}
>
